...
pref("extensions.redirectfilter@irkit.ru.description", "chrome://redirectfilter/locale/redirectfilter.properties");
...
pref("extensions.redirectfilter.redirectSequencesHeaders.enabled", true); // In-reply-to and references headers
